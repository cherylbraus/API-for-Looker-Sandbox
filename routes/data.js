const dataRoutes = (app, fs) => {
  ...
  app.get('/dataSankey2', (req, res) => {
    fs.readFile(dataPathSankey2, 'utf8', (err, data) => {
      if (err) {
        throw err;
      }
  ...
  app.get('/dataSankey3', (req, res) => {
    fs.readFile(dataPathSankey3, 'utf8', (err, data) => {
      if (err) {
        throw err;
      }
  ...
  app.get('/dataConWinRate', (req, res) => {
    fs.readFile(dataPathConWinRate, 'utf8', (err, data) => {
      if (err) {
        throw err;
      }
  ...
  app.get('/dataConWinRate2', (req, res) => {
    fs.readFile(dataPathConWinRate2, 'utf8', (err, data) => {
      if (err) {
        throw err;
      }
  ...
  app.get('/dataLineTest', (req, res) => {
    fs.readFile(dataPathLineTest, 'utf8', (err, data) => {
      if (err) {
        throw err;
      }
  ...
  app.get('/dataDivergingAnn', (req, res) => {
    fs.readFile(dataPathDivergingAnn, 'utf8', (err, data) => {
      if (err) {
        throw err;
      }
